...
INSERT INTO `filescan_history` VALUES (13,'D:\\文件\\客户端\\源文件\\信号\\增量文件20.txt',14,0),(14,'D:\\文件\\客户端\\源文件\\信号\\PDF10.exe',65939296,65),(15,'D:\\文件\\客户端\\源文件\\信号\\T119.exe',20689928,20),(16,'D:\\文件\\客户端\\源文件\\信号\\PDF11.exe',65939296,65),(17,'D:\\文件\\客户端\\源文件\\信号\\PDF12.exe',65939296,65),(18,'D:\\文件\\客户端\\源文件\\信号\\PDF13.exe',65939296,65),(19,'D:\\文件\\客户端\\源文件\\信号\\[国家宝藏]千年古琴再被奏响10.mp4',17592320,17);
...
INSERT INTO `tb_tranparam` VALUES (1513,3,'TEMP_DIR','临时目录','D:\\PROJECTS\\文件\\目录配置\\临时目录'),(1514,3,'BACK_DIR','备份目录','D:\\PROJECTS\\文件\\目录配置\\备份目录'),(1515,3,'MSG_DIR','短信目录','D:\\PROJECTS\\文件\\目录配置\\短信目录'),(1516,3,'DOWNLOAD_DIR','下载目录','D:\\PROJECTS\\文件\\目录配置\\下载目录'),(1517,3,'REQUEST_DIR','请求目录','D:\\PROJECTS\\文件\\目录配置\\请求目录'),(1518,4,'SERVER_IP','服务器 IP','127.0.0.1'),(1519,4,'SERVER_PORT','服务器端口','11028'),(1520,5,'BLOCK_SIZE','文件分块大小（MB）','1'),(1521,5,'THREAD_POOL_SIZE','线程池大小（个）','1'),(1522,5,'PRIORITY1_WEIGHT','优先级1权重','5'),(1523,5,'PRIORITY2_WEIGHT','优先级2权重','4'),(1524,5,'PRIORITY3_WEIGHT','优先级3权重','3'),(1525,5,'PRIORITY4_WEIGHT','优先级4权重','2'),(1526,5,'PRIORITY5_WEIGHT','优先级5权重','1'),(1527,5,'EXPIRE_TIME','超时时间（毫秒）','3000'),(1528,5,'DATAGRAM_SIZE','数据包大小（字节）','3000'),(1529,14,'FILETYPE_BINARY','二进制','优先级一级'),(1530,14,'FILETYPE_IMAGE','图片','优先级二级'),(1531,14,'FILETYPE_VIDEO','视频','优先级三级'),(1532,13,'SOURCE_DIR','源目录','D:\\PROJECTS\\文件\\源文件\\轨道几何'),(1533,13,'UPLOAD_DIR','上传目录','D:\\PROJECTS\\文件\\上传文件\\轨道几何'),(1534,15,'SOURCE_DIR','源目录','D:\\文件\\客户端\\源文件\\信号'),(1535,15,'UPLOAD_DIR','上传目录','D:\\PROJECTS\\文件\\上传文件\\信号'),(1536,16,'FILETYPE_BINARY','二进制','优先级一级'),(1537,16,'FILETYPE_IMAGE','图片','优先级二级'),(1538,16,'FILETYPE_VIDEO','视频','优先级四级'),(1539,5,'UPLOAD_FILE_COUNT','上传文件数量（个）','10'),(1540,5,'DOWNLOAD_FILE_COUNT','下载文件数量（个）','1'),(1541,4,'DEFAULT_MAC','默认 MAC 地址','94B86DAE0100');
...
INSERT INTO `tb_users` VALUES (3,'aa','a'),(5,'test','aa'),(7,'test11','aa'),(8,'admin','admin');
...
-- Dump completed on 2018-12-04 21:11:47
