...
INSERT INTO `tb_tranparam` VALUES (2296,3,'TEMP_DIR','临时目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\目录配置\\临时目录'),(2297,3,'BACK_DIR','备份目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\目录配置\\备份目录'),(2298,3,'MSG_DIR','短信目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\目录配置\\短信目录'),(2299,3,'DOWNLOAD_DIR','下载目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\目录配置\\下载目录'),(2300,3,'REQUEST_DIR','请求目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\目录配置\\请求目录'),(2301,4,'SERVER_IP','服务器 IP','127.0.0.1'),(2302,4,'SERVER_PORT','服务器端口','11028'),(2303,5,'BLOCK_SIZE','文件分块大小（MB）','1'),(2304,5,'THREAD_POOL_SIZE','线程池大小（个）','200'),(2305,5,'PRIORITY1_WEIGHT','优先级1权重','5'),(2306,5,'PRIORITY2_WEIGHT','优先级2权重','4'),(2307,5,'PRIORITY3_WEIGHT','优先级3权重','3'),(2308,5,'PRIORITY4_WEIGHT','优先级4权重','2'),(2309,5,'PRIORITY5_WEIGHT','优先级5权重','1'),(2310,5,'EXPIRE_TIME','超时时间（毫秒）','3000'),(2311,5,'DATAGRAM_SIZE','数据包大小（字节）','1400'),(2312,14,'FILETYPE_BINARY','二进制','优先级一级'),(2313,14,'FILETYPE_IMAGE','图片','优先级二级'),(2314,14,'FILETYPE_VIDEO','视频','优先级三级'),(2315,13,'SOURCE_DIR','源目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\源文件\\轨道几何'),(2316,13,'UPLOAD_DIR','上传目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\上传文件\\轨道几何'),(2317,15,'SOURCE_DIR','源目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\源文件\\信号'),(2318,15,'UPLOAD_DIR','上传目录','D:\\Projects\\FengHuang\\TIELU\\测试\\客户端\\上传目录\\信号'),(2319,16,'FILETYPE_BINARY','二进制','优先级一级'),(2320,16,'FILETYPE_IMAGE','图片','优先级二级'),(2321,16,'FILETYPE_VIDEO','视频','优先级四级'),(2322,5,'UPLOAD_FILE_COUNT','上传文件数量（个）','100'),(2323,5,'DOWNLOAD_FILE_COUNT','下载文件数量（个）','1'),(2324,4,'DEFAULT_MAC','默认 MAC 地址','98EECB848861');
...
INSERT INTO `tb_tranparam_tree` VALUES (1,1,2,'通用配置'),(2,1,11,'专业配置'),(3,2,3,'目录配置'),(4,2,4,'传输配置'),(11,11,13,'轨道几何'),(12,11,15,'信号');
...
-- Dump completed on 2019-01-14  0:34:39
